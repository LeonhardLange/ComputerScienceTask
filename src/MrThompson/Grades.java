...
public class Grades extends JFrame{
    ...
    String dayCount = "";
    public Grades() { //Creates the page
        ...
        saveButton.addActionListener(new ActionListener() { //Button to save table values to file
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    FileWriter file = new FileWriter("C:\\Users\\xenia\\IdeaProjects\\MrThompson\\src\\MrThompson\\grades" + dayCount + "txt");
        ...
        loadButton.addActionListener(new ActionListener() { //Button to load values from file
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    file = new FileReader("C:\\\\Users\\\\xenia\\\\IdeaProjects\\\\MrThompson\\\\src\\\\MrThompson\\\\grade" + dayCount + "txt");
                    file2 = new FileReader("C:\\Users\\xenia\\IdeaProjects\\MrThompson\\src\\MrThompson\\grade" + dayCount + "txt");
                } catch (FileNotFoundException ex) {
    ...
    private void createTable() {
        ...
        table1.setModel(new DefaultTableModel( //Creates table
                data,
                new String[]{"Name", "Grade"} //Column names
        ));
    }
}
