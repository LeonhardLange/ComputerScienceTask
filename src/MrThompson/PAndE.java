...
public class PAndE extends JFrame{
    ...
    public PAndE() { //Creates the page
        ...
        saveButton.addActionListener(new ActionListener() { //Button to save table values to file
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    FileWriter file = new FileWriter("C:\\Users\\xenia\\IdeaProjects\\MrThompson\\src\\MrThompson\\engagement" + dayCount + "txt");
        ...
        loadButton.addActionListener(new ActionListener() { //Button to load values from file
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    file = new FileReader("C:\\\\Users\\\\xenia\\\\IdeaProjects\\\\MrThompson\\\\src\\\\MrThompson\\\\engagement" + dayCount + "txt");
                    file2 = new FileReader("C:\\Users\\xenia\\IdeaProjects\\MrThompson\\src\\MrThompson\\engagement" + dayCount + "txt");
                } catch (FileNotFoundException ex) {
    ...
    private void createTable() {
        ...
        table1.setModel(new DefaultTableModel( //Creates table
                data,
                new String[]{"Name", "Engagement"} //Column names
        ));
    }
}
